...
# Default DB name for this app
	define('DB_NAME', 'estherwe_p4_estherweeks_info'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'PzILMR3z-9mMEB6uaESuz*s92kFzsbj5QoWaHh&X');
	define('TOKEN_SALT', 'bHJA90QlBBvpKkpHLZDl0xzGmhyrSbtJBmzbkc04');