...
<?php foreach($projects as $project): ?>
	<article>
		...
		<!--modal content for delete file -->
			<div id="fileModal<?=$project['date_start']?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="fileModalLabel<?=$project['date_start']?>" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
							<h4 class="modal-title" id="fileModalLabel<?=$project['date_start']?>">Are You Sure?</h4>
						</div>
